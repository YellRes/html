...
/*
 * 是否是6-30位数字或字母组成， 必须字母开头 （12306用户名）
 * @return bool
 * */
function isUserName12306(str){ 
    return /^[A-Za-z]{1}([A-Za-z0-9]|[_]){5,29}$/.test(str);
}

/*
 * 是否是6-20位字母、数字或符号组成的密码 （12306密码）
 * @return bool
 * */
function isUserPwd12306(str){ 
    return /^[\x21-\x7E]{6,20}$/.test(str);
}
module.exports={
    isMobile:isMobile,
    isIdCard:isIdCard,
    isChineseOrEnglish:isChineseOrEnglish,
    isEmail:isEmail,
    isUserName12306:isUserName12306,
    isUserPwd12306:isUserPwd12306
};